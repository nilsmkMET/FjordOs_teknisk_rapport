...
% Include graphs
   \rput[bl](-0.2,0.0){\includegraphics[height=9cm]{dyp_old}}
%   \rput[bl]( 0.5,0.0){\includegraphics[height=9cm]{Map_Oslofjord_with_topography}}
%   \rput[bl]( 7.5,0.0){\includegraphics[height=9cm]{Fig01_2}}
   \rput[br](15.0,1.0){\includegraphics[height=7.3cm]{Map_location_Oslofjord_2}}
