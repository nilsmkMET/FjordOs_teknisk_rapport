...
%% is replaced by:
  {\includegraphics[height=5cm]{kap5/salt_hele_0_current_crop_forside}}	% Graphic. Automatically uses PDF or EPS in same directory depending on latex or pdflatex.
 \end{center}
\end{figure}
